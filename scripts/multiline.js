...
//Create axis
   // chartObj.xAxis = d3.svg.axisBottom().scale(chartObj.xScale).tickFormat(chartObj.xFormatter); //< Can be overridden in definition

   // chartObj.yAxis = d3.svg.axisLeft().scale(chartObj.yScale).tickFormat(chartObj.yFormatter); //< Can be overridden in definition
